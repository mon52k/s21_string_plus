...
#define int_to_string_wrapper(value, str)                               \
  _Generic((value), int                                                 \
           : int_to_string((long long)(value), str), unsigned int       \
           : int_to_string((long long)(value), str), long               \
           : int_to_string((long long)(value), str), unsigned long      \
           : int_to_string((long long)(value), str), long long          \
           : int_to_string((long long)(value), str), unsigned long long \
           : int_to_string((long long)(value), str), short              \
           : int_to_string((long long)(value), str), unsigned short     \
           : int_to_string((long long)(value), str))
